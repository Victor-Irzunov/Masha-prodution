...
import { Form, Input, Checkbox, message, Button, AutoComplete } from 'antd';
...
const FormLogin = ({ handleCancel, fromPage }) => {
	...
	return (
		<>
			<Form layout="vertical" name="logIn" form={form} onFinish={onFinish} onFinishFailed={onFinishFailed} style={{ overflowX: 'hidden' }}>
				<Form.Item
					label="Логин"
					name="email"
